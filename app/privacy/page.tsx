...
export const metadata: Metadata = {
  title: "プライバシーポリシー",
  description: "エアコン修理ナビのプライバシーポリシーです。個人情報の取り扱いについて定めています。",
};
    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-8 text-sm leading-relaxed text-gray-700">
          ...
          <p>
            株式会社MediaX（以下「当社」）が運営するエアコン修理ナビ（以下「当サイト」）は、利用者の個人情報の保護を重要な責務と考え、以下のプライバシーポリシーを定めます。
          </p>

          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3 pb-2 border-b-2 border-sky-500">個人情報の収集</h2>
            <p className="mb-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3 pb-2 border-b-2 border-sky-500">利用目的</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3 pb-2 border-b-2 border-sky-500">第三者提供</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3 pb-2 border-b-2 border-sky-500">Cookie・アクセス解析ツール</h2>
            <p className="mb-2">
            ...
            <p>
              Cookieの使用を希望しない場合は、ブラウザの設定にてCookieを無効にすることができます。ただし、Cookieを無効にすると当サイトの一部機能が利用できなくなる場合があります。Google Analyticsの詳細については、
              <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-sky-600 hover:underline">Googleのプライバシーポリシー</a>
              をご確認ください。
            </p>
          </section>

          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3 pb-2 border-b-2 border-sky-500">広告配信（アフィリエイト）</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3 pb-2 border-b-2 border-sky-500">個人情報の管理</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3 pb-2 border-b-2 border-sky-500">お問い合わせ</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-bold text-slate-900 mb-3 pb-2 border-b-2 border-sky-500">ポリシーの変更</h2>
            <p>
