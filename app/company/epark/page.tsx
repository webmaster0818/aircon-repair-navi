...
export const metadata: Metadata = {
  title:
    "EPARKくらしのレスキューの評判・口コミは？エアコン修理の料金・対応を徹底調査【2026年最新】",
  description:
    "「EPARKくらしのレスキュー」の評判・口コミは実際どう？生活トラブルの業者を検索・予約できるサービスのエアコン修理について、掲載業者の口コミの傾向、料金の目安、受付時間や依頼の流れ、メリット・デメリットまで中立的に解説します。",
