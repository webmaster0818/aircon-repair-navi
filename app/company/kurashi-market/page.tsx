...
export const metadata: Metadata = {
  title:
    "くらしのマーケットのエアコン修理は評判が悪い？口コミ・料金を他社比較で徹底調査【2026年最新】",
  description:
    "くらしのマーケットのエアコン修理は評判が悪い？料金は高い？マッチング型サービスの実際の口コミ・評判を出典付きで、料金の目安・口コミで業者を選べる仕組みを他社と比較。メリット・デメリット、向いている人まで中立的に徹底調査します。",
