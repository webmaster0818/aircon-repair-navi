...
export const metadata: Metadata = {
  title:
    "家仲間コムの評判は悪い？口コミ・エアコン修理の料金は高い？他社比較で徹底調査【2026年最新】｜エアコン修理ナビ",
  description:
    "家仲間コムの評判は悪い？料金は高い？エアコン工事・修理の業者マッチングサイトについて、手数料無料で工事費が安くなる傾向や写真見積もりの速さ、利用者の生の声、申込の流れを他社と比較。メリット・デメリットまで中立的に徹底調査します。",
