...
export const metadata: Metadata = {
  title:
    "ミツモアのエアコン修理の評判は？料金・口コミ・仕組みを実査【2026年7月】",
  description:
...
const faqs = [
  {
    ...
    a: "ミツモアは、依頼内容を入力すると最短1分で最大5社のプロ（出店者）から見積もりが届く、見積もり比較・マッチング型のプラットフォームです。届いた見積もりや各事業者の口コミ・評価を比べて、依頼者が自分で依頼先を選びます。運営する株式会社ミツモア自身は施工を行わず、実際の作業を行うのは選んだプロです（2026年7月12日公式確認）。",
  },
  {
    q: "依頼者に手数料はかかりますか？",
      ...
      <article className="bg-white">
        ...
        <div className="max-w-3xl mx-auto px-5 pt-8">
          <p className="text-[1.05rem] leading-8 text-slate-700">
            ...
            この記事では、最短1分で最大5社から見積もりが届くマッチング型プラットフォーム
        ...
        <div className="max-w-3xl mx-auto px-5 mt-12 space-y-14">
          <section id="summary" className="scroll-mt-24">
            ...
            <p className="leading-8 text-slate-700">
              ミツモアは、株式会社ミツモアが運営する<strong className="font-semibold">見積もり比較・受発注プラットフォーム</strong>です。依頼者が質問に沿って希望条件を選ぶだけで、最短1分で最大5社のプロ（出店者）から見積もりが届く仕組みで、エアコンの修理・交換・取り付け・取り外し・クリーニングから、暮らしのサービス、士業・ビジネス分野まで幅広いカテゴリを扱っています。
            </p>
            <p className="mt-4 leading-8 text-slate-700">
              重要なのは、<strong className="font-semibold">運営会社自身は施工を行わない</strong>点です。届いた見積もりと各プロの口コミ・評価を見比べて、依頼者が自分で依頼先を選び、実際の作業は選んだプロが担当します。そのため料金の相場を把握しながら納得して選びたい人に向く一方、作業の品質・対応・保証はプロによって差が出ます（2026年7月12日公式確認）。
            </p>
          </section>
          ...
          <CtaBox
            ...
            note="最短1分で最大5社から見積もりが届きます。依頼者の手数料は0円・契約義務なし。"
          />
          ...
          <section id="flow" className="scroll-mt-24">
            ...
            <ol className="space-y-4">
              {[
                ["条件を入力して見積もり依頼", "質問に沿って希望条件を選ぶだけで、最短1分で見積もり依頼が完了します。依頼者の費用は0円です。"],
          ...
          <section id="last" className="scroll-mt-24">
            ...
            <p className="leading-8 text-slate-700">
              ミツモアは、最短1分で最大5社から見積もりが届き、料金と口コミを見比べて依頼先を選べる見積もり比較・マッチング型プラットフォームです。依頼者の手数料は0円で、最高1億円の損害賠償補償も用意されています。一方で、運営会社は施工せず、実際の作業・品質・許認可・保証はすべて選んだプロ次第のため満足度に差が出ることがあり、見積もりから依頼まで手間・時間がかかることもあります。依頼時には「口コミの件数・内容の確認」「追加料金の条件をチャットで確認」「電気工事を伴う場合はプロの許認可・資格の確認」の3点を押さえれば、マッチング型の弱点はほぼカバーできます。
            </p>
            <p className="mt-4 leading-8 text-slate-700">
