...
export const metadata: Metadata = {
  title:
    "ケーズデンキエアコン修理の口コミ・評判は？料金・申込方法を徹底調査【2026年最新】｜エアコン修理ナビ",
  description:
    "家電量販店ケーズデンキの出張修理について、口コミ・評判、料金の考え方、診断・点検・出張料の注意点、WEB受付の申込方法を中立的に解説します。大手量販店の安心感と、事前見積もり確認のポイントをまとめました。",
