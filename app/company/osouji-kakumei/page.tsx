...
const goodReviews = [
  {
    body:
      "ビフォーアフターの写真でカビの量が一目でわかりました。カビ臭さが消えて、風の通りも変わった気がします。",
    who: "利用者の声",
    source: "みん評(おそうじ革命 エアコンクリーニングの口コミ)を要約",
  },
  {
    body:
      "作業前に流れや注意点をきちんと説明してくれて、質問にもわかりやすく答えてもらえました。",
    who: "利用者の声",
    source: "みん評(おそうじ革命の口コミ)を要約",
  },
  {
    body:
      "丁寧かつ迅速で、エアコンの状態も詳しく教えていただき、とても大満足でした。",
    who: "千葉市若葉区の利用者(2026年6月)",
    source: "おそうじ革命公式サイト掲載のGoogle口コミ",
  },
  {
    body:
      "大手で安心感があり、価格も抑えめでコストパフォーマンスが良かったです。",
    who: "利用者の声",
    source: "Googleマップ(おそうじ革命)の口コミを要約",
  },
];
      ...
      <article className="bg-white">
        ...
        <div className="max-w-3xl mx-auto px-5 pt-8">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-500">
            ※おそうじ革命は故障の「修理」ではなく、内部を分解洗浄する「エアコンクリーニング」のサービスです。本記事の口コミは、みん評・Googleマップ・公式サイト等で公開されている利用者の声を引用・要約したものです。料金や対応内容は時期・地域・店舗により変わるため、最新の情報は申し込み時にご確認ください(調査時点：2026年6月)。
          </p>
        </div>
        ...
        <div className="max-w-3xl mx-auto px-5 mt-12 space-y-14">
          ...
          <section id="good" className="scroll-mt-24">
            ...
            <p className="leading-8 text-slate-700 mb-6">
              口コミで目立つのは、
              <strong className="font-semibold">仕上がりへの満足と、料金のわかりやすさ・コスパ</strong>
              を評価する声です。カビ臭さが消えた、ビフォーアフター写真で汚れが一目でわかった、説明が丁寧だった、といった内容が見られます。
            </p>
            ...
            <p className="mt-4 text-xs text-slate-400">※上記はみん評・Googleマップ・公式サイト等で公開されている利用者の声を引用・要約したものです。みん評では多数の口コミが投稿されており、料金の安さと基本的な品質を評価する傾向が見られます。</p>
          </section>
