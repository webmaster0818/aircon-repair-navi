...
export const metadata: Metadata = {
  title:
    "電気工事110番の口コミ・評判は？料金・対応エリアを徹底調査【2026年最新】｜エアコン修理ナビ",
  description:
    "東証上場企業が運営する「電気工事110番」の口コミ・評判をまとめました。実際の利用者の声、料金の目安、対応エリアや受付時間、メリット・デメリットを中立的に解説。生活110番とは別運営である点もあわせて紹介します。",
