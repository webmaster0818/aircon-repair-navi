...
export const metadata: Metadata = {
  title:
    "ヤマダ電機エアコン修理の口コミ・評判は？料金・申込方法を徹底調査【2026年最新】｜エアコン修理ナビ",
  description:
    "家電量販店ヤマダ電機の出張修理（ヤマダテクニカルサービス）について、口コミ・評判、料金の考え方、診断料・出張料の注意点、申込方法を中立的に解説します。大手の安心感と、事前見積もり確認のポイントをまとめました。",
...
const goodReviews = [
  {
    body:
      "全国に店舗がある大手の量販店なので、修理を頼むときも安心感がありました。窓口がはっきりしているのが心強いです。",
    who: "利用者の声",
    source: "体験談ブログなどで紹介されている利用者の声",
  },
  {
    body:
      "出張修理の申込みから訪問までの段取りがわかりやすく、大手ならではの安心感を感じました。",
    who: "利用者の声",
    source: "体験談ブログなどで紹介されている利用者の声",
  },
];
...
const faqs = [
  {
    q: "ヤマダ電機の出張修理はどこで購入した製品でも対応してもらえますか？",
    a: "ヤマダ電機の出張修理は、ヤマダテクニカルサービスが対応する出張前提のサービスです。対応可否や条件は製品・購入状況によって異なる場合があるため、申込時に対応可能かを確認しておくと安心です。",
  },
  {
    q: "出張費や診断料はかかりますか？",
    a: "出張費の目安は3,500円〜5,000円程度とされています。また、見積もり後にキャンセルした場合や修理ができなかった場合に、診断料1,100円と出張料3,850円の合計4,950円が発生するケースがあるとされています。費用が気になる場合は、申込時に出張費・診断料の有無と金額を確認しておくのがおすすめです。",
  },
  {
    q: "エアコンを持ち込んで修理できますか？",
    a: "エアコンは設置された状態で点検・修理する出張修理が前提です。持ち込みでの対応はできないとされています。",
  },
  {
    q: "修理料金はどのくらいかかりますか？",
    a: "料金は症状や必要な作業によって変わります。出張費とは別に、部品代や作業費がかかります。正確な金額は現地での見積もりで確認し、内容に納得してから依頼すると安心です。",
  },
  {
    q: "申込みはどこからできますか？",
    a: "ヤマダテクニカルサービスの公式サイトの出張修理ページから申込みができます。症状や設置状況を伝えると、訪問の調整に進みます。",
  },
];
...
const articleJsonLd = {
  ...
  "@type": "Article",
  headline:
    "ヤマダ電機エアコン修理の口コミ・評判は？料金・申込方法を徹底調査【2026年最新】",
    ...
    <>
      ...
      <Breadcrumb
        items={[
          ...
          { name: "ヤマダ電機 出張修理の口コミ・評判", href: "/company/yamada-repair" },
        ]}
      />
      ...
      <article className="bg-white">
        ...
        <div className="max-w-3xl mx-auto px-5 pt-8">
          <p className="text-[1.05rem] leading-8 text-slate-700">
            ...
            この記事では、
            <strong className="font-semibold text-slate-900">ヤマダ電機の出張修理（ヤマダテクニカルサービス）</strong>
            について、紹介されている利用者の声、料金の考え方、診断料・出張料の注意点、申込方法を、良い点・気になる点の両面から中立的にまとめました。
          </p>
        ...
        <div className="max-w-3xl mx-auto px-5 mt-12 space-y-14">
          <section id="summary" className="scroll-mt-24">
            <h2 className="text-2xl font-bold text-slate-900 border-l-4 border-sky-600 pl-4 mb-5">ヤマダ電機 出張修理とは</h2>
            <p className="leading-8 text-slate-700">
              ヤマダ電機の出張修理は、ヤマダホールディングスグループのヤマダテクニカルサービスが対応する、エアコンなどの家電の出張修理サービスです。技術スタッフが自宅を訪問し、設置された状態のエアコンを点検・修理します。
            </p>
            <p className="mt-4 leading-8 text-slate-700">
              全国に店舗を展開する大手家電量販店のグループが運営しているため、窓口がはっきりしていて相談しやすい点が特徴です。エアコンは持ち込みではなく、出張での対応が前提となっています。
            </p>
          </section>
            ...
            <div className="overflow-hidden rounded-2xl border border-slate-200">
              <table className="w-full text-[0.95rem]">
                <tbody>
                  {[
                    ["サービス名", "ヤマダ電機 出張修理"],
                    ["運営会社", "株式会社ヤマダテクニカルサービス（ヤマダホールディングスグループ）"],
                    ["サービス形態", "家電量販店グループによる出張修理（持ち込み不可・出張前提）"],
                    ["出張費の目安", "約3,500円〜5,000円（公称の目安）"],
                    ["診断料・出張料", "見積もり後キャンセル／修理不能時に 診断料1,100円＋出張料3,850円＝計4,950円が発生する場合あり"],
                    ["対応", "エアコンの出張修理（症状・機種により料金変動）"],
                    ["申込方法", "公式サイトの出張修理ページから申込み"],
          ...
          <section id="good" className="scroll-mt-24">
            ...
            <p className="leading-8 text-slate-700 mb-6">
              ...
              <strong className="font-semibold">大手家電量販店ならではの安心感</strong>
              を評価する内容です。窓口がはっきりしていて、申込みから訪問までの段取りがわかりやすいという声が見られます。
            </p>
          ...
          <section id="bad" className="scroll-mt-24">
            ...
            <p className="leading-8 text-slate-700 mb-4">
              ...
              <strong className="font-semibold">診断料・出張料が別途発生する場合がある</strong>
              点は理解しておきたいところです。費用面で想定外がないよう、申込時には次の点を確認しておくとよいでしょう。
            </p>
            <ul className="space-y-3 text-slate-700 leading-7">
              <li className="flex gap-3"><span className="text-sky-600 font-bold shrink-0">・</span>出張費（約3,500円〜5,000円の目安）が修理代とは別にかかる場合がある</li>
              <li className="flex gap-3"><span className="text-sky-600 font-bold shrink-0">・</span>見積もり後にキャンセル、または修理ができなかった場合に診断料・出張料がかかるケースがある</li>
              <li className="flex gap-3"><span className="text-sky-600 font-bold shrink-0">・</span>持ち込みでの修理はできず、出張での対応が前提となっている</li>
              <li className="flex gap-3"><span className="text-sky-600 font-bold shrink-0">・</span>申込前に、出張費・診断料の有無と総額の見積もりを確認しておくと安心</li>
            </ul>
          </section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-sky-100 bg-sky-50/60 p-6">
                ...
                <ul className="space-y-2 text-slate-700 text-[0.95rem] leading-7">
                  <li>全国展開の大手家電量販店グループで、窓口がはっきりしていて安心感がある</li>
                  <li>申込みから訪問までの段取りがわかりやすい</li>
              ...
              <div className="rounded-2xl border border-slate-200 bg-white p-6">
                ...
                <ul className="space-y-2 text-slate-700 text-[0.95rem] leading-7">
                  <li>出張費・診断料が別途発生する場合がある（事前確認推奨）</li>
                  <li>修理不能・キャンセル時にも費用がかかるケースがある</li>
                  <li>持ち込み不可で、出張での対応が前提</li>
                </ul>
              </div>
            </div>
          </section>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-slate-200 p-6">
                ...
                <ul className="space-y-2 text-slate-700 text-[0.95rem] leading-7">
                  ...
                  <li>申込みから訪問までの段取りがわかりやすい方がよい人</li>
          ...
          <section id="price" className="scroll-mt-24">
            ...
            <p className="leading-8 text-slate-700">
              ヤマダ電機の出張修理では、修理代とは別に
              <strong className="font-semibold">出張費（約3,500円〜5,000円の目安）</strong>
              がかかる場合があります。また、見積もり後にキャンセルした場合や修理ができなかった場合に、診断料1,100円と出張料3,850円の合計4,950円が発生するケースがあるとされています。
            </p>
            <p className="mt-4 leading-8 text-slate-700">
          ...
          <section id="flow" className="scroll-mt-24">
            ...
            <ol className="space-y-4">
              {[
                ["公式サイトから申込み", "出張修理ページから、症状や設置状況、製品情報を入力して申込みます。"],
                ["費用・条件の確認", "出張費・診断料の有無や金額など、条件を事前に確認しておくと安心です。"],
                ["訪問日時の調整", "都合の良い日時を調整し、技術スタッフが訪問します。"],
          ...
          <section id="last" className="scroll-mt-24">
            ...
            <p className="leading-8 text-slate-700">
              ヤマダ電機の出張修理は、全国展開の大手家電量販店グループが運営し、窓口がはっきりしていて相談しやすい点が強みです。体験談でも大手ならではの安心感を評価する声が見られます。一方で、出張費や、キャンセル・修理不能時の診断料・出張料が別途発生する場合があるため、申込時に費用の有無と金額を確認し、現地の見積もりに納得してから依頼するのが安心です。
            </p>
            <p className="mt-4 leading-8 text-slate-700">
              エアコン修理は症状によって費用が変わります。急ぎでないときは複数の選択肢で料金と対応を比較し、納得して選ぶと失敗を防げます。
            </p>

            <div className="mt-8 rounded-2xl bg-gradient-to-br from-sky-700 to-sky-900 p-7 text-center text-white">
              <p className="text-lg font-bold mb-2">エアコンの出張修理を検討している方へ</p>
              <p className="text-sky-100 text-sm mb-5">まずは申込み前に、出張費・診断料の有無と費用の目安を確認してみましょう。</p>
              <a href="https://yamada-dws.jp/service/" target="_blank" rel="noopener noreferrer" className="inline-block rounded-full bg-white px-7 py-3 font-bold text-sky-800 hover:bg-sky-50 transition-colors">
