...
export const metadata: Metadata = {
  title:
    "住まいのホットラインの評判・口コミは？エアコン修理の料金・対応を徹底調査【2026年最新】",
  description:
    "「住まい（すまい）のホットライン」の評判・口コミは実際どう？暮らしのトラブルを口コミ・料金で比較できる予約サービスのエアコン修理について、利用者の声の傾向、料金の目安、受付時間や依頼の流れ、メリット・デメリットまで中立的に解説します。",
